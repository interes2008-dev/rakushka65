        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a href="https://max.ru/+79147690097" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 font-body text-sm text-muted-foreground hover:text-[#0077FF] transition-colors"><MessageCircle className="w-4 h-4 text-[#0077FF]" />Max</a>
            </div>
          </div>
        </div>
