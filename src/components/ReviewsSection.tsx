...
const reviewsData = {
  ru: [
    { name: "Команда «Посейдон»", role: "Партнёры, Сочи", text: "Ребята, вы — наши люди! Когда на побережье Чёрного моря подают сахалинские устрицы и гости не верят, что это возможно — мы просто улыбаемся. Rakushka65 — больше чем поставщик, это друзья, которые никогда не подводят. Обнимаем с берега на берег! 🤝", initials: "П" },
    { name: "Алексей Морозов", role: "Шеф-повар, ресторан «Берег»", text: "Работаем с Rakushka65 уже два года. Качество устриц и гребешков — на высшем уровне. Гости в восторге, а для нас главное — стабильность поставок.", initials: "АМ" },
    ...
    { name: "Елена Танака", role: "Владелица суши-бара «Нори»", text: "Перепробовали десяток поставщиков — остановились на Rakushka65. Вонголе и гребешок приходят живыми, клиенты чувствуют разницу. Это другой уровень.", initials: "ЕТ" },
    ...
    { name: "Анна Ким", role: "Фуд-блогер, @sakhalin_food", text: "Снимала обзор сахалинских устриц — ребята из Rakushka65 прислали отборные экземпляры. Подписчики завалили вопросами, где заказать. Теперь только к ним!", initials: "АК" },
    ...
    { name: "Сергей Ковалёв", role: "Шеф-повар, Москва", text: "В столице сложно найти живого гребешка такого качества. Rakushka65 решили эту проблему — прилетает за сутки, как будто сам на Сахалин слетал.", initials: "СК" },
