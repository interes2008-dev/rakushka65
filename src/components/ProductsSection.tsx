...
export const products: Product[] = [
  {
    ...
    unit: "кг",
    rating: 5,
    description: "Нежный, сладковатый вкус с ароматом океана. Живой, охлаждённый.",
    category: "Моллюски",
    weight: "от 200 г / шт",
    taste: "Нежный, сладковатый",
    fullDescription: "Морской гребешок — настоящий деликатес с невероятно нежной текстурой и сладковатым послевкусием. Идеален для тартара, севиче или быстрого обжаривания на гриле.",
  },
  {
    id: "oysters",
    ...
    fullDescription: "Устрицы Фин де Клер — эталон французской гастрономии. Выдерживаются в клерах — специальных прибрежных бассейнах, что придаёт им утончённый вкус с нотками фундука.",
  },
  {
    id: "vongole",
    name: "Вонголе",
  ...
  },
  {
    ...
    unit: "кг",
    rating: 4,
    description: "Редкий деликатес с плотной текстурой и ярким вкусом моря.",
    category: "Моллюски",
    weight: "от 50 г / шт",
    taste: "Плотный, яркий",
    fullDescription: "Спизула — редкий и ценный двустворчатый моллюск. Обладает плотной текстурой и выраженным морским вкусом. Отлично подходит для сырых подач и горячих блюд.",
  },
];
