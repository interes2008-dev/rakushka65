...
export const products: Product[] = [
  ...
  { id: "hairy-crab", name: "Краб мохнаторукий", image: hairyCrabImg, price: "1200", unit: "кг", rating: 5, description: "", category: "Ракообразные", weight: "80-250 г / шт", taste: "Плотное мясо, морской вкус" },
];
  ...
  return (
    <section className="relative py-24 md:py-32">
      <div className="container mx-auto px-4">
        ...
        >
          {products.filter((p) => !p.hidden).slice(0, 10).map((product) => (
            <motion.div
              key={product.id}
              className="h-full"
              variants={{
