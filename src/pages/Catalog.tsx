...
const categories = ["Все", "Устрицы", "Моллюски"];
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="font-heading text-5xl md:text-6xl font-bold mb-4">
              Каталог <span className="text-gradient-teal">морепродуктов</span>
            </h1>
            <p className="text-muted-foreground font-body max-w-lg mx-auto">
              Живые и охлаждённые деликатесы прямо с побережья
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="flex flex-wrap items-center justify-between gap-4 mb-10 bg-sand-glass rounded-xl p-4"
          >
            ...
            <div className="flex items-center gap-3">
              <select
                ...
                className="px-3 py-2 bg-muted/50 border border-border/50 rounded-lg font-body text-sm text-foreground focus:outline-none focus:border-primary/50"
              >
            ...
            {sorted.map((product, i) => (
              ...
              >
                <Link
                  ...
                  className={`block bg-card rounded-xl overflow-hidden border border-border/50 group hover:border-primary/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/5 ${
                ...
                >
                  ...
                  <div className="p-5 flex-1">
                    <div className="flex items-center gap-1 mb-2">
                      ...
                      <span className="ml-2 text-xs text-muted-foreground font-body">{product.category}</span>
                    </div>
