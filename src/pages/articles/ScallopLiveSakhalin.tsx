...
const ScallopLiveSakhalin = () => {
  ...
  return (
    ...
    >
      ...
      <p>
        Закажите живого гребешка на странице <Link to="/catalog/scallop">«Морской гребешок»</Link> или свяжитесь с нашим менеджером. Минимальная партия — 5 кг, доставка по всей России. Подробнее о том, <Link to="/blog/kak-vybrat-grebeshok">как выбрать качественный гребешок</Link> и <Link to="/blog/kak-prigotovit-grebeshok">как его правильно приготовить</Link>, читайте в наших экспертных гидах.
      </p>
