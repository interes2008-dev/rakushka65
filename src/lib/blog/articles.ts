...
export const blogArticles: BlogArticle[] = [
  ...
  },
  {
    ...
    description: "Безалкогольная настойка трепанга на мёде: пошаговый рецепт, технология, схема приёма, польза для иммунитета и противопоказания. Подходит детям и пожилым.",
    date: "2026-04-25",
